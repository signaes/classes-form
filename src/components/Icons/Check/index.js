...
const Check = ({ fill = '#92C5B8', className = '' }: Props) => (
  <svg width="8px" height="6px" viewBox="0 0 8 6" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" className={className}>
